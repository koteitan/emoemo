...
(kind:10030) and emoji sets / emoji packs (kind:30030).

Live: https://koteitan.github.io/emoemo/

## Features

- **Login**: NIP-07 browser extension (Alby, nos2x, etc.). Browsing packs works without login.
- **Find emoji packs**: list recent kind:30030 and search via NIP-50 relays.
- **My emoji list (kind:10030)**: edit and publish individual emoji and pack references (`a` tags).
- **Emoji packs (kind:30030)**: create and edit — title, identifier (d), emoji (shortcode + image URL).
